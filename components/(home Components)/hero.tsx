...
const HeroSection: React.FC = () => {
  ...
  const handlePortfolioClick = () => {
    navigateWithLoader(
      "/portfolio",
      "Exploring our amazing portfolio...",
      2000
    );
  };

  const handleContactClick = () => {
    navigateWithLoader("/contact", "Setting up your consultation...", 2000);
  };

  return (
    <div className="relative w-full py-8 sm:py-8 lg:py-16 overflow-hidden">
      {/* Background Animation */}
      <div className="absolute inset-0 z-0">
        <Threads
          color={[0.173, 0.455, 0.737]} // #2C74BC
          amplitude={
            typeof window !== "undefined" && window.innerWidth < 768 ? 0.8 : 1.2
          }
          distance={
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-5xl mx-auto w-full">
          ...
          {/* CTA Buttons with Navigation Loader */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4 sm:px-0">
            <button
              onClick={handlePortfolioClick}
              disabled={isLoading}
              className={`w-full sm:w-auto group relative px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-white bg-[#2C74BC] hover:bg-[#2C74BC]/90 transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-lg text-sm sm:text-base ${
            ...
            <button
              ...
              disabled={isLoading}
              className={`w-full sm:w-auto relative px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-[#2C74BC] border-2 border-[#2C74BC] hover:bg-[#2C74BC] hover:text-white transition-all duration-300 hover:scale-105 hover:-translate-y-1 text-sm sm:text-base ${
                isLoading ? "opacity-50 cursor-not-allowed" : ""
              }`}
            >
