...
const AboutSection = ({
  ...
  const handleConnectClick = () => {
    navigateWithLoader(
      "/contact",
      "Connecting you to our contact page...",
      2000
    );
  };
    ...
    <section className="overflow-hidden relative mt-12 sm:mt-16 lg:mt-20 xl:mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 py-2 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-4 items-start">
            ...
            <div className="relative">
              ...
              <div className="pl-2 sm:pl-4 lg:pl-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-snug">
                  Yes, we're <span className="text-[#2C74BC]">creative!</span>
                </h2>
          ...
          <div
            className={`lg:col-span-7 space-y-8 transform transition-all duration-1000 delay-500 ${
              isVisible
                ? "translate-x-0 opacity-100"
                : "translate-x-10 opacity-0"
            }`}
        ...
        >
          <div className="inline-flex items-center space-x-4">
            <button
              ...
              disabled={isLoading}
              className={`group relative overflow-hidden bg-white text-[#2C74BC] px-10 py-4 rounded-full font-semibold text-lg border-2 border-[#2C74BC] hover:bg-[#2C74BC] hover:text-white transition-all duration-300 shadow-lg hover:shadow-2xl disabled:opacity-70 disabled:cursor-not-allowed ${
                isLoading ? "bg-[#2C74BC] text-white" : ""
              }`}
            >
              {isLoading ? (
