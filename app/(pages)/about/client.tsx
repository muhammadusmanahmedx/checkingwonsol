...
// import { InfiniteSlider } from "@/components/(home Components)/logocarousalplanning-strategy-concept-min_bpzzoy.jpg",
...
export default function AboutClient() {
  ...
  return (
    <>
      ...
      <div className="space-y-10 text-center mt-20 px-4">
        <motion.h1
          className="font-bold text-3xl md:text-5xl text-gray-900"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        >
          Our <span className="text-[#2C74BC]">Clients</span>
        </motion.h1>

        <p className="max-w-2xl mx-auto text-gray-600 text-base md:text-lg">
          We’ve had the privilege to collaborate with some amazing
          organizations. Here are a few of the clients who trust us with their
          projects.
        </p>
        ...
        <InfiniteSlider
          ...
          duration={20}
          durationOnHover={60}
          className="w-full bg-card rounded-lg p-6 md:p-8"
          // slides={ltrSlides}
        />
      </div>
      ...
      <div className="py-20 px-8 bg-white w-full min-h-screen">
        <div className="max-w-7xl mx-auto text-center px-4">
          <motion.h1
            className="font-bold text-3xl md:text-5xl text-gray-900 mb-4"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
          >
          ...
          <motion.p
            className="text-sm md:text-lg text-gray-600 max-w-3xl mx-auto py-4 mb-12"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {/* <WonSolutionsTimeline timelineData={timelineData} /> */}
